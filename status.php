...
$query="SELECT party, COUNT(1) AS VOTES FROM voters GROUP BY party";
$data=$db->query($query);
...
<table border="3" align="center" style="margin-top:50px">
	<tr>
		<td colspan="2"><h4><b>PARTY</b></h4></td>
		<td colspan="2"><h4><b>VOTES</b></h4></td>
	</tr>
	<tr>
		<td colspan="2"><?php echo $result[0][party] ?></td>
		<td colspan="2"><?php echo $result[0][VOTES] ?></td>
	</tr>
	<tr>
		<td colspan="2"><?php echo $result[1][party] ?></td>
		<td colspan="2"><?php echo $result[1][VOTES] ?></td>
	</tr>
	<tr>
		<td colspan="2"><?php echo $result[2][party] ?></td>
		<td colspan="2"><?php echo $result[2][VOTES] ?></td>
	</tr>
	<tr>
		<td colspan="2"><?php echo $result[3][party] ?></td>
		<td colspan="2"><?php echo $result[3][VOTES] ?></td>
	</tr>
</table>
